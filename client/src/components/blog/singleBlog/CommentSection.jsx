...
import { MessageCircle, SendHorizonal, User, Clock, Sparkles } from "lucide-react"
      ...
      <Card className="relative overflow-hidden shadow-xl border-0 bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/40 backdrop-blur-xl rounded-2xl">
        ...
        <CardContent className="relative p-6 lg:p-8 space-y-6">
          ...
          <div className="max-h-[300px] overflow-y-auto pr-2 space-y-3 custom-scrollbar">
            {loading ? (
              [...Array(2)].map((_, i) => (
                <div key={i} className="animate-pulse bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-white/20 shadow-sm">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-sm font-medium text-gray-800">{comment.user?.name || "Anonymous"}</span>
